...
<body>
    <div class="container">
        <div class="row mt-4 offset-4">
            <div class="col-5">
                <h2 class="mt-3 mb-3">Update student information</h2>
                <form action="update.php?id=<?php echo $student['id']; ?> " method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="roll" value="<?php echo $student['roll'] ;?>"  class="form-control" id="roll">
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlIgpa " class="form-label">gpa</label>
                        <input type="text" name="gpa" value="<?php echo $student['gpa'] ;?>"  class="form-control" id="gpa">
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlIage " class="form-label">Age</label>
                        <input type="text" name="age"  value="<?php echo $student['age'] ;?>" class="form-control" id="age">
                    </div>
